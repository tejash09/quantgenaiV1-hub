        ...
        <div className="container mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8 fade-in-section">
            ...
            >
              ...
              <p className="text-gray-600 dark:text-gray-400">
                Join a community of like-minded individuals passionate about advancing technology and sharing knowledge.
              </p>
            </motion.div>
          </div>
        </div>
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li className="text-gray-400">
                  ...
                  <a href="mailto:info@quantgenailabs.com" className="text-quantum-300 hover:text-quantum-200">
                    info@quantgenailabs.com
                  </a>
                </li>
                <li className="text-gray-400">
                  <span className="block">Phone:</span>
                  <a href="tel:+1234567890" className="text-quantum-300 hover:text-quantum-200">
                    +1 (234) 567-890
                  </a>
                </li>
                <li className="text-gray-400">
